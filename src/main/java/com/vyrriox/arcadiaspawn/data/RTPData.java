package com.vyrriox.arcadiaspawn.data;
...
public class RTPData {
    ...
    public BlockPos getLastRtpPos() {
        return lastRtpPos;
    }

    public void setLastRtpPos(BlockPos lastRtpPos) {
        this.lastRtpPos = lastRtpPos;
    }

    public void copyFrom(RTPData other) {
        this.usages = other.usages;
        this.lastRtpPos = other.lastRtpPos;
    }
}
